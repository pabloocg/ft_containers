#ifndef MULTISET_TEST_CPP
# define MULTISET_TEST_CPP
...
{
	{
		...
		ft::multiset<int> second (first.begin(),first.end());
	...
	}
	{
		...
		ft::multiset<int> first (myints,myints+5);   // multiset with 5 ints
		ft::multiset<int> second;                    // empty multiset

		second=first;                                 // now second contains the 5 ints
		first=ft::multiset<int>();                   // and first is empty
	...
	}
	{
		...
		ft::multiset<int> mymultiset (myints,myints+5);

		std::cout << "mymultiset contains:";
		for (ft::multiset<int>::reverse_iterator rit=mymultiset.rbegin(); rit!=mymultiset.rend(); ++rit)
			std::cout << ' ' << *rit;
	...
	}
	{
		...
		ft::multiset<int> first (myints,myints+3);     // 4,19,72
		ft::multiset<int> second (myints+3,myints+6);  // 20,20,36

		first.swap(second);

		std::cout << "first contains:";
		for (ft::multiset<int>::iterator it=first.begin(); it!=first.end(); ++it)
			std::cout << ' ' << *it;
		std::cout << '\n';
	...
	}
	{
		...
		int myints[]={10,73,12,22,73,73,12};
  		ft::multiset<int> mymultiset (myints,myints+7);
	...
	}
	{
		...
		std::pair<ft::multiset<int>::iterator,ft::multiset<int>::iterator> ret = mymultiset.equal_range(30); //      ^        ^
	...
	}
	{
		...
		ft::multiset<int> multiset1;
		multiset1.insert(10);
		multiset1.insert(1);
		multiset1.insert(1);
		multiset1.insert(100);

		ft::multiset<int> multiset2;
		multiset2.insert(10);
		multiset2.insert(1);
		multiset2.insert(1);
