#ifndef MULTIMAP_TEST_CPP
# define MULTIMAP_TEST_CPP
...
void        multimap_test(void)
{
	...
	}
	{
		...
		// show content:
		ft::multimap<char,int>::reverse_iterator rit;
	...
	}
	{
		...
		ft::multimap<char,int>::iterator it = mymm.find('x');
		mymm.erase (it);
	...
	}
	{
		...
		ft::multimap<char,int> mymultimap;
		ft::multimap<char,int>::iterator it,itlow,itup;
	...
	}
	{
		...
		{
			std::pair <ft::multimap<char,int>::iterator, ft::multimap<char,int>::iterator> ret;
